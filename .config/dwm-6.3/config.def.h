...
static Key keys[] = {
    ...
    { MODKEY,                       XK_e,      focusnthmon,    {.i  = 0 } },
    { MODKEY|ShiftMask,             XK_w,      tagnthmon,      {.i  = 1 } },
    { MODKEY|ShiftMask,             XK_e,	   tagnthmon,      {.i  = 0 } },
	...
	TAGKEYS(                        XK_8,                      7)
	TAGKEYS(                        XK_9,                      8)
	// since i have autorestart scrtipt for DWM in my .xprofile
	// quiting DWM actually means restarting
